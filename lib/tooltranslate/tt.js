/*
	Always include this file as https://localhost/cartografiaschaco/lib/tooltranslate/tt.js
...
function ToolTranslation ( intitial_params ) {
	...
	this.toolinfo = {} ;
	this.tool_path = 'https://cartografiaschaco.altcooperativa.com/lib/tooltranslate/' ; // 'https://tooltranslate.toolforge.org/' ;
	this.tool_path = 'https://localhost/cartografiaschaco/lib/tooltranslate/' ; // 'https://tooltranslate.toolforge.org/' ;
