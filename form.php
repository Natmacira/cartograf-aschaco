...
<form action="validation-form.php">
    ...
    <label for="terminos" id="terms-label"><input type="checkbox" id="terminos" name="terminos" value="" required>Acepto los &nbsp <strong> <a href="terminos.php"> términos y condiciones</a></strong></label><br>
