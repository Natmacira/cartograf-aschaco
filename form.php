...
if (isset($_POST['contact'])) {
	...
	if ($form_result === 'Success') {
		...
		<label for="terminos" id="terms-label"><input type="checkbox" id="terminos" name="terminos" value="" required>Acepto los <strong> <a target="_blank" href="terminos.php"> términos y condiciones</a></strong></label><br>
