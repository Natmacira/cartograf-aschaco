...
// require_once ( 'legacy/php/wikidata.php' ) ;
// require_once ( 'legacy/php/Widar.php' ) ;
require_once ( 'legacy/magnusmanske-magnustools/public_html/php/wikidata.php' ) ;
require_once ( 'legacy/magnusmanske-magnustools/public_html/php/Widar.php' ) ;
