 ...
 */
$inifile = '/data/project/oauth-hello-world/oauth-hello-world-enduser.ini';
$inifile = 'oauth.ini';
...
If you come back and click "Make an edit!" again before the browser session expires, the application will remember the authorization token and skip straight to step 5. And if you happen to have gone to <a href="https://meta.wikimedia.org/wiki/Special:OAuthManageMyGrants">Special:OAuthManageMyGrants on meta.wikimedia.org</a> and revoked the access token in the mean time, it will receive an error when it tries to edit and will automatically go to step 2.
