...
var wikiSettings = {
	ts_catscan_api : 'http://toolserver.org/~magnus/catscan_rewrite.php' ,
	stats_grok : 'stats.grok.se' ,
	accessPreferences : {
		pagesInCategoryTree : 'api'
	} ,
	images : {
		spin : 'http://upload.wikimedia.org/wikipedia/commons/d/d2/Spinning_wheel_throbber.gif'
	}
} ;
...
WikiPage.prototype.getApiRoot = function () {
	...
	return "http://" + this.lang + "." + this.project + ".org/w/api.php" ;
}
...
//	http://wikimedia.org/api/rest_v1/metrics/pageviews/per-article/en.wikipedia/all-access/user/Richard_Dawkins/daily/20150901/20150930
