...
<head>
	...
	<script>
		var languagesCartografias = <?php 
		include_once "lib\tooltranslate\data\languages-custom.json";
	?>
	</script>
	...
	<div id='top'>
		<nav class="navbar navbar-light bg-faded">
			...
			<ul class="language-ul">
				...
				<form action="">
					<!-- en coordenadas trae las coordenadas por defecto ya en el código hay que ver como manejamos eso -->
					<p>llamada del json</p><p>coordenadas que se llaman desde el mapa</p>
					<label>llamada del json<input type="text" name="titulo"></label>
					<label>llamada del json<input type="file" name="imagen"></label>
					<label>llamada del json<input type="text" name="descripcion"></label>
					<label>llamada del json<input type="text" name="extra"></label>
				</form>
