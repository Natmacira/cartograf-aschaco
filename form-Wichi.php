...
if (isset($_POST['contact'])) {
	...
	if ($form_result === 'Success') {
		...
		<label for="terminos" id="terms-label"><input type="checkbox" id="terminos" name="terminos" value="" required><strong> <a target="_blank" href="terminos-Wichi.php">watlok nñhanej mak tojh tothalhn’uya tojh ihi plataformana</a></strong></label><br>
